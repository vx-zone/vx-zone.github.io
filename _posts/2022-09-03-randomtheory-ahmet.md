...
# Random Numbers Through Computer Algorithms
...
We are going to generate a pseudorandom numbers generated by the linear conqruence method with modules m=9, multiplier a = 7 , increment  c = 4 , and seed X0 = 3
